...
class SSFRoutesHandler implements \Ninja\NJInterface\IRoutes
{
    ...
    public function __construct()
    {
        ...
        $this->sync_table = new DatabaseTable(SyncEntity::TABLE, SyncEntity::PRIMARY_KEY, SyncEntity::CLASS_NAME);
    ...
    public function getRoutes(): array
    {
        ...
        $sync_model = new SyncModel($this->sync_table);
        $sync_api_handler = new SyncApi($sync_model);
        ...
        $sync_routes = $this->get_sync_api_route($sync_api_handler);
        ...
        return $user_routes + $wallet_routes + $category_routes + $wallet_log_routes + $auth_routes + $home_controller_routes + $auth_controller_routes + $wallet_controller_routes + $wallet_log_controller_routes + $sync_routes;
    }
    ...
    private function get_sync_api_route(SyncApi $wallet_api_handler): array
    {
        return [
