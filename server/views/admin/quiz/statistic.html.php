...
{% block title %}<?= $shop_name ?? 'SSF' ?> - Admin - Thống kê bài trắc nghiệm{% endblock %}
...
<div class="my-5">
    <h1 class="h2">Thống kê bài trắc nghiệm</h1>
</div>

<div class="row my-4">
    <div class="col-md-6">
        <a href="/admin/quiz" class="btn btn-secondary">Quay lại</a>
    </div>
</div>

<div class="min-vh-100">
    <h3 class="h5 text-center">Biểu đồ số lượng câu hỏi theo bài trắc nghiệm</h3>
    ...
    <table class="table table-bordered text-center">
        ...
        <tr class="table-primary">
            ...
            <th scope="col">Số lượng bài trắc nghiệm</th>
        </tr>
        </thead>
        <tbody>
