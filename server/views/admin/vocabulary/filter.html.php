...
<div class="row my-4">
    ...
    <div class="col-md-6 d-flex justify-content-end align-items-start">
        ...
        <a href="/admin/vocabularies/create" class="btn btn-primary">Thêm mới</a>
    </div>
</div>
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <div class="row col-md-4">
                            <form action="/admin/vocabularies/filter/topic" method="POST">
                                <div class="mb-3">
...
<div class="min-vh-100">
    <table class="table">
        ...
        <tbody>
        <?php foreach ($filter_vocabularies as $index => $vocabulary) : ?>
            <tr>
        ...
        <ul class="pagination justify-content-center flex-wrap">
            <?php for ($i = 0; $i <= $number_of_page; $i++): ?>
                <li class="page-item <?= ($i + 1) == $current_page ? 'active' : '' ?>">
                    <a class="page-link"
                       href="/admin/vocabularies/filter/topic?topic_id=<?= $filtered_topic_id ?>&page=<?= $i + 1 ?>"><?= $i + 1 ?></a>
                </li>
            <?php endfor; ?>
        </ul>
    </nav>
